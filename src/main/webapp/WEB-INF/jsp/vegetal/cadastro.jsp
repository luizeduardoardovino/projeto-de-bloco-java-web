<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<body>
			...
			<div class="container">
				<h2>Cadastro de Vegetal</h2>
				<form action="/vegetal/incluir" method="POST">
					...
					<div class="form-group">
						...
						<select class="form-control" name="tipo">
							<option selected="selected">Pequeno</option>
							<option>Médio</option>
					...
					<div class="form-group">
						...
						<input value="0" min="25" step="1" max="70" type="number" class="form-control" required
							placeholder="Entre com a quantidade de peças da decoração" name="qtdVegetal">
					</div>
